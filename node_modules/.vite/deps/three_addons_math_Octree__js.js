...
var Octree = class _Octree {
  ...
  triangleBoxIntersect(box, triangle) {
    ...
    const intersection = {
      depth: -distance,
      // Flip sign so depth is positive
